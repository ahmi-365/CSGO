                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <div className="mb-3 relative">
                                            ...
                                            <Input
                                                ...
                                                className="w-full bg-[#0D0F14] border border-white/10 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-primary"
                                            />
                                            {weaponSearchQuery && (
                                                <button
                                            ...
                                            {filteredAvailableWeapons.length === 0 ? (
                                                ...
                                                filteredAvailableWeapons.map(weapon => (
                                                    <label key={weapon.id} className="flex items-center gap-3 p-2 hover:bg-white/5 rounded cursor-pointer border-b border-white/5 last:border-0">
                                                        ...
                                                        {weapon.price && (
                                                            <span className="text-primary text-sm font-semibold">${weapon.price}</span>
                                                        )}
                                                    </label>
                                                ))
                                            )}
                                    ...
                                    {filteredAvailableWeapons.length > 0 && (
                                        <div className="flex gap-2">
                                            <button
                                                onClick={() => {
                                                    const allFilteredIds = filteredAvailableWeapons.map(w => w.id);
                                                ...
                                                className="flex-1 bg-gray-700 hover:bg-gray-600 text-white rounded-lg px-3 py-2 text-sm font-medium transition-colors"
                                            >
                                                Select All {weaponSearchQuery && `(${filteredAvailableWeapons.length})`}
                                            </button>
                                            <button
