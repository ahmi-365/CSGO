...
export default function AccountContent({}: Props) {
  ...
  const copyClipBoard = (e: string) => {
    navigator.clipboard.writeText(e).then(() => alert(`Copied Successfully: ${e}`));
  };
      ...
      <div className="p-2 md:p-4 bg-white/4 rounded-xl mb-3">
        <div className="flex items-center justify-between mb-3 md:mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="">
              <h4 className="text-lg text-white font-satoshi font-bold !leading-[110%] mb-2">
                O Items • $0.00
              </h4>
          ...
          <p className="text-base text-[#39FF67] font-satoshi font-medium !leading-[140%]">
            Completed
          </p>
        </div>
        ...
        <div className="flex items-center gap-y-3 justify-between flex-wrap mt-3">
          <h4 className="text-base text-[currentColor] font-satoshi font-medium !leading-[140%]">
            Trade Offer ID:
          </h4>
          <p className="text-sm md:text-base text-[#C3C4CC] flex font-normal items-center gap-2">
            bclqxy2k... fjhx0wlh
            <button
              onClick={() => copyClipBoard("bclqxy2k... fjhx0wlh")}
